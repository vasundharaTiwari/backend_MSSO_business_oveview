...
public class DtoMssoAdvancesRegionwise {
    ...
    public DtoMssoAdvancesRegionwise(String region, Date report_date, BigDecimal advances, BigDecimal reg_adv, BigDecimal total_npa, BigDecimal freez_npa) {
        this.region = region;
        this.report_date = report_date;
        this.advances = advances;
        this.reg_adv = reg_adv;
